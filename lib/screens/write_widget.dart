        ...
        builder: (context) => SingleChildScrollView(
          child: Column(children: <Widget>[
            Container(
              ...
              child: Center(
                child: Text('Review for ${data['repo_det']}',
                    style: TextStyle(
                        fontSize: 20,
                      ...
                      TextFormField(
                        ...
                        validator: (String value) {
                          if (value.isEmpty)
                            ...
                            this.advPercent = int.tryParse(value);
                            return null;
                          }
                        },
                      ),
                      ...
                      FlatButton(
                        onPressed: () async {
                          if (_formkey.currentState.validate()) {
                            post(
                                'https://spider.nitt.edu/inductions20test/api/mentor/submissionFeedback',
                                headers: {
                                ...
                                body: jsonEncode({
                                  ...
                                  "advanced_task_percent": this.advPercent
                                })).then((Response resp) {
