  ...
  Widget build(BuildContext context) {
    ...
    if (data['git'] == '')
      return Scaffold(
        ...
        body: Center(
            child: Text('Mentee Github account not found',
                style: TextStyle(
                    fontSize: 18,
      ...
      return DefaultTabController(
          ...
          child: Scaffold(
            ...
            appBar: AppBar(
              ...
              title: Text('Mentee task'),
              centerTitle: true,
              bottom: TabBar(indicatorColor: config.tab, tabs: [
                Container(
                ...
                child: Column(children: <Widget>[
                  ...
                  Text('Task details',
                      style: TextStyle(
                          ...
                          color: config.fontColor)),
                  SizedBox(height: 10),
                  Stats(data['name'], data['git'], data['jwt'],
                      data['menteeroll']), //remove unnecessary
                ]),
              ),
            ]),
          ));
