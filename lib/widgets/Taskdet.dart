...
String jwttoken;  
List profiles;
TaskDet(this.jwttoken, this.profiles);

  @override
  _TaskDetState createState() => _TaskDetState(this.jwttoken, this.profiles);
}
     ...
     child: ListView.builder(
        ...
        itemBuilder: (context, index){
          return FutureBuilder(
            future: get('https://spider.nitt.edu/inductions20test/api/profile/${this.profiles[index]}',
         headers: {
        ...
        builder: (context, snapshot){
                        ...
                        child: Column(
                         ...
                         Text(temp['tasks']['$j']['task_title'],  style: TextStyle( fontSize: 20, fontFamily: config.fontFamily, color: config.head)),
                           SizedBox(
                            ...
                            FutureBuilder(
                               future:  get('https://spider.nitt.edu/inductions20test/api/task/${temp['tasks']['$j']['task_id']}',
                               headers: {
                              HttpHeaders.authorizationHeader: 'Bearer ${this.jwttoken}'
                                }),
             ...
             return Text('No data found',  style: TextStyle( fontSize: 18, fontFamily: config.fontFamily, color: config.fontColor));
             }
